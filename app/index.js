  ...
  writing: {
    app: function () {
      ...
      switch (this.props.tdef) {
        ...
        case 'Node':
          tdef = factory.createContainerNode();
          break;
      }
      tdef.name = this.props.name;
      tdef.version = this.props.version;
      model.select('**/packages[name='+pkgs[pkgs.length-1]+']').get(0).addTypeDefinitions(tdef);
      ...
      var filepath = this.destinationPath('model.json');
